@echo off
REM Test Validation and Limits Script
REM Plant Disease Classification System

echo ========================================
echo Test Validation and Limits
echo ========================================
echo.
echo This script will test file validation and guest limits
echo to ensure they are working correctly.
echo.
...
echo [INFO] Running validation and limits tests...
echo.

node test-validation-and-limits.js
