@echo off
REM Test Login Endpoint Script
...
echo ========================================
echo.
echo This script will test the login endpoint
echo to ensure it's working correctly.
echo.
...
echo [INFO] Running login endpoint tests...
echo.
